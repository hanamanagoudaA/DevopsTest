...
<html>
    ...
    <body>
        ...
        <div  id="footer">
            ...
            <center>
                <a href="viewByPassANI.jsp">View ByPass ANI</a>

                <h1>ByPass ANI Configuration</h1>  

                <!--<h3 style='color: #3090C7'>Provide ANI's With '<font style="color: green">Comma Separated</font>' Values</h3>-->
                   <form id="UploadForm" action="BIEBypassANIServlet" method="post"  enctype="multipart/form-data">
